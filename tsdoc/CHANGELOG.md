...
- Add more standard tag definitions: `@deprecated`, `@eventProperty`, `@example`, `@inheritDoc`, `@internalRemarks`, `@link`, `@override`, `@packageDocumentation`, `@preapproved`, `@public`, `@sealed`, `@virtual`
